...
class slOrderStatusSortProcessor extends modObjectProcessor
{
	 ...
	 * @return array|string
	 */
	public function sort(slOrderStatus $source, slOrderStatus $target)
	{
...
return 'slOrderStatusSortProcessor';