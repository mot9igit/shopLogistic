...
class slOrderProductUpdateProcessor extends modObjectUpdateProcessor
{
	public $classKey = 'slOrderProduct';
	public $objectType = 'slOrderProduct';
	public $languageTopics = array('shoplogistic');
	public $beforeSaveEvent = 'slOnBeforeUpdateOrderProduct';
	public $afterSaveEvent = 'slOnUpdateOrderProduct';
...
return 'slOrderProductUpdateProcessor';