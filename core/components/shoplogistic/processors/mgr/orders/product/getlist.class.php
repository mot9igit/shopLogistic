...
class slOrderProductGetListProcessor extends modObjectGetListProcessor
{
	public $classKey = 'slOrderProduct';
	public $languageTopics = array('shoplogistic:product');
...
return 'slOrderProductGetListProcessor';