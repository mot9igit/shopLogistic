...
class slStoreUsersUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('shoplogistic_storeusers_err_ns');
        }
...
return 'slStoreUsersUpdateProcessor';
